...
AgmPolygon.propDecorators = {
    ...
    'draggable': [{ type: core_1.Input, args: ['polyDraggable',] },],
    ...
    'polyClick': [{ type: core_1.Output },],
    'polyDblClick': [{ type: core_1.Output },],
    'polyDrag': [{ type: core_1.Output },],
    'polyDragEnd': [{ type: core_1.Output },],
    'polyDragStart': [{ type: core_1.Output },],
    'polyMouseDown': [{ type: core_1.Output },],
    'polyMouseMove': [{ type: core_1.Output },],
    'polyMouseOut': [{ type: core_1.Output },],
    'polyMouseOver': [{ type: core_1.Output },],
    'polyMouseUp': [{ type: core_1.Output },],
    'polyRightClick': [{ type: core_1.Output },],
};
