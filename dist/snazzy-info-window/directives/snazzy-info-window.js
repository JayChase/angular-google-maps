...
var AgmSnazzyInfoWindow = (function () {
    function AgmSnazzyInfoWindow(_marker, _wrapper, _manager, _loader) {
         ...
         */
        this.beforeOpen = new core_1.EventEmitter();
        /**
         * Emits before the info window closes.
         */
        this.afterClose = new core_1.EventEmitter();
...
AgmSnazzyInfoWindow.ctorParameters = function () { return [
    { type: core_2.AgmMarker, decorators: [{ type: core_1.Optional }, { type: core_1.Host }, { type: core_1.SkipSelf },] },
...
AgmSnazzyInfoWindow.propDecorators = {
    ...
    'borderRadius': [{ type: core_1.Input },],
    'fontColor': [{ type: core_1.Input },],
    'fontSize': [{ type: core_1.Input },],
    'pointer': [{ type: core_1.Input },],
    'shadow': [{ type: core_1.Input },],
    'openOnMarkerClick': [{ type: core_1.Input },],
    'closeOnMapClick': [{ type: core_1.Input },],
    'wrapperClass': [{ type: core_1.Input },],
    'closeWhenOthersOpen': [{ type: core_1.Input },],
    'showCloseButton': [{ type: core_1.Input },],
    'panOnOpen': [{ type: core_1.Input },],
    'beforeOpen': [{ type: core_1.Output },],
    'afterClose': [{ type: core_1.Output },],
    '_outerWrapper': [{ type: core_1.ViewChild, args: ['outerWrapper', { read: core_1.ElementRef },] },],
    '_viewContainerRef': [{ type: core_1.ViewChild, args: ['viewContainer', { read: core_1.ViewContainerRef },] },],
    '_templateRef': [{ type: core_1.ContentChild, args: [core_1.TemplateRef,] },],
};
